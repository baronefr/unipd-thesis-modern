...
\documentclass[%
    %language=italian, % italian or english (default) localization
]{unipd-thesis-modern} % src: https://github.com/baronefr/unipd-thesis-modern
...
\thesisHeader{Department of Physics and Astronomy ``G. Galilei''\\Master Thesis in Physics}
\academicYear{2025/2026}
% \graduationDate{22/07/2026} % (optional)
...
% supervisor(s)Zürich
\advisor{Prof. Albert Einstein}{University of Zürich} % (mandatory)
\coadvisor{Dr. Bruce Wayne}{University of Gotham} % (optional, comment to remove)
...
%% Some departments/schools still require the usage of the old logo.
...
\begin{document}
    ...
    % NOTE: I suggest creating a file for each chapter, like the previous \input{}.
